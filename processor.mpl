...
CodeNode: [{
  ...
  varNameInfo: -1 dynamic; #variable name of importedtion
  moduleId: -1 dynamic;
...
Processor: [{
  ...
  capsModuleNames: String Int32 HashTable; # -1 no module, or Id of codeNode
  ...
  globalInitializer: -1 dynamic; # index of for calling all initializers
